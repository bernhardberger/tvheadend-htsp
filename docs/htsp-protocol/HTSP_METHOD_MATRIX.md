...
| 6 | `tagDelete` | — | yes | `tagId`:u32 [required] — fields/complete |
| 7 | `dvrEntryAdd` | 4 | yes | `id`:u32 [unknown], `idStr`:str [unknown], `enabled`:u32 [unknown], `channel`:u32 [unknown], `channelName`:str [unknown], `eventId`:u32 [unknown], `autorecId`:str [unknown], `timerecId`:str [unknown], `start`:s64 [unknown], `stop`:s64 [unknown], `startExtra`:s64 [unknown], `stopExtra`:s64 [unknown], `retention`:u32 [unknown], `removal`:u32 [unknown], `priority`:u32 [unknown], `contentType`:u32 [unknown], `ageRating`:u32 [unknown], `ratingLabel`:str [unknown], `ratingIcon`:str [unknown], `ratingAuthority`:str [unknown], `ratingCountry`:str [unknown], `playcount`:u32 [unknown], `playposition`:u32 [unknown], `title`:str [unknown], `description`:str [unknown], `summary`:str [unknown], `subtitle`:str [unknown], `owner`:str [unknown], `creator`:str [unknown], `comment`:str [unknown], `image`:str [unknown], `fanartImage`:str [unknown], `copyrightYear`:u32 [unknown], `files`:list [unknown] → `recordingFile`, `path`:str [unknown], `configId`:str [unknown], `duplicate`:u32 [unknown], `state`:str [unknown], `error`:str [unknown], `subscriptionError`:str [unknown], `streamErrors`:u32 [unknown], `dataErrors`:u32 [unknown], `dataSize`:s64 [unknown] — fields/partial |
| 8 | `dvrEntryUpdate` | 4 | yes | `id`:u32 [unknown], `idStr`:str [unknown], `enabled`:u32 [unknown], `channel`:u32 [unknown], `channelName`:str [unknown], `eventId`:u32 [unknown], `autorecId`:str [unknown], `timerecId`:str [unknown], `start`:s64 [unknown], `stop`:s64 [unknown], `startExtra`:s64 [unknown], `stopExtra`:s64 [unknown], `retention`:u32 [unknown], `removal`:u32 [unknown], `priority`:u32 [unknown], `contentType`:u32 [unknown], `ageRating`:u32 [unknown], `ratingLabel`:str [unknown], `ratingIcon`:str [unknown], `ratingAuthority`:str [unknown], `ratingCountry`:str [unknown], `playcount`:u32 [unknown], `playposition`:u32 [unknown], `title`:str [unknown], `description`:str [unknown], `summary`:str [unknown], `subtitle`:str [unknown], `owner`:str [unknown], `creator`:str [unknown], `comment`:str [unknown], `image`:str [unknown], `fanartImage`:str [unknown], `copyrightYear`:u32 [unknown], `files`:list [unknown] → `recordingFile`, `path`:str [unknown], `configId`:str [unknown], `duplicate`:u32 [unknown], `state`:str [unknown], `error`:str [unknown], `subscriptionError`:str [unknown], `streamErrors`:u32 [unknown], `dataErrors`:u32 [unknown], `dataSize`:s64 [unknown] — fields/partial |
| 9 | `dvrEntryDelete` | 4 | yes | `id`:u32 [required] — fields/complete |
...
| 19 | `initialSyncCompleted` | 2 | yes | _knownEmpty/complete_ |
| 20 | `muxpkt` | — | yes | `subscriptionId`:u32 [required], `frametype`:u32 [required], `stream`:u32 [required], `dts`:s64 [optional], `pts`:s64 [optional], `duration`:u32 [required], `payload`:bin [required] — fields/complete |
| 21 | `queueStatus` | — | yes | `subscriptionId`:u32 [required], `packets`:u32 [required], `bytes`:u32 [required], `delay`:s64 [conditional], `Bdrops`:u32 [required], `Pdrops`:u32 [required], `Idrops`:u32 [required] — fields/complete |
| 22 | `subscriptionStart` | — | yes | `meta`:bin [unknown], `streams`:list [unknown] → `stream`, `sourceinfo`:msg [unknown] → `sourceInfo`, `subscriptionId`:u32 [unknown] — fields/partial |
| 23 | `subscriptionStop` | — | yes | `subscriptionId`:u32 [unknown], `status`:str [unknown], `subscriptionError`:str [unknown] — fields/partial |
