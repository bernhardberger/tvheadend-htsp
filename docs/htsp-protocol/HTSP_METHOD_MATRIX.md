...
- Client→server methods referenced in production sources: **31 / 39**
- Distinct outgoing request names: **30 / 39**
- Server→client messages handled (exact literal): **27 / 30**
- Public typed client requests from the reviewed catalog: **23 / 39**
