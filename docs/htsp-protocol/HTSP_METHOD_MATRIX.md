...
| 33 | `subscriptionFilterStream` | `ACCESS_HTSP_STREAMING` | 12 (annotated) | yes | yes | `subscriptionId`:u32 [required], `enable`:list [optional] → `u32`, `disable`:list [optional] → `u32` — fields/complete | _knownEmpty/complete_ |
