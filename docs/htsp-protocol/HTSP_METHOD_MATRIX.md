...
- Client→server methods referenced in production sources: **30 / 39**
- Distinct outgoing request names: **29 / 39**
- Server→client messages handled (exact literal): **27 / 30**
- Public typed client requests from the reviewed catalog: **22 / 39**
